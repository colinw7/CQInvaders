...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sat Sep 14 08:04:15 2013
# Project:  CQInvaders.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile CQInvaders.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lSDL -lSDL_mixer -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Makefile: CQInvaders.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/CQInvaders1.0.0 || $(MKDIR) .tmp/CQInvaders1.0.0 
...
moc_CQSpaceInvaders.cpp: CQSpaceInvaders.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) CQSpaceInvaders.h -o moc_CQSpaceInvaders.cpp
...
CQSpaceInvaders.o: CQSpaceInvaders.cpp CQSpaceInvaders.h \
		CQSound.h \
		CSpaceInvaders.h
